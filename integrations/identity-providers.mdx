...
<CardGroup cols={2}>
  <Card title="Okta" img="/images/okta_logo.png" href="/integrations/okta">
    Complete Okta integration with SSO and SCIM provisioning
  </Card>
  
  <Card title="Google Workspace" img="/images/google_logo.png" href="/integrations/google-workspace">
    Sync users and groups from Google Workspace
  </Card>
  
  <Card title="Microsoft Entra ID" img="/images/ms_entra_id_logo.png" href="/integrations/microsoft-entra-id">
