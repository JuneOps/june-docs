...
This connects the **OpenAI Platform**, your organization's API and developer bill. It does not cover ChatGPT Enterprise seats, which are billed separately; for those, see [ChatGPT Enterprise](/integrations/chatgpt-enterprise).
