...
<Steps>
  <Step title="Generate a Team Admin API key">
    ...
    3. Give the key the **`admin:*`** scope. June reads team members, usage, and spend through the Admin API, and a read-only scope will connect and then fail on the first sync.
    4. Copy the key.
  </Step>
