...
<div className="w-30 h-30">
  <img src="/images/google_integration.png" alt="Google Workspace Integration" className="my-5 w-100 h-100" />
</div>
...
For permission-aware Knowledge sources from shared drives, connect [Google Drive](/integrations/google-drive) separately under **Integrations → Knowledge**.
