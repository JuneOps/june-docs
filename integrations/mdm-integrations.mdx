...
<CardGroup cols={2}>
  ...
  <Card href="/integrations/kandji">
    <div className="w-30 h-30">
      <img src="/images/kandji.svg" alt="Kandji" width={40} height={40} className="my-5" />
    </div>
  ...
  <Card href="/integrations/apple-business-manager">
    <div className="w-30 h-30">
      <img src="/images/abm-dark-mode.svg" alt="Apple Business Manager" width={40} height={40} className="my-5" />
    </div>
