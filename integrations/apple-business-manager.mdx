...
<Steps>
  <Step title="Access Integrations">
    ...
    4. Click **Connect** to begin setup
  </Step>
  
  <Step title="Enter API Credentials">
    Fill in the required authentication fields:
    - **Client ID**: Your ABM Client ID (UUID format from Apple Business Manager)
    - **Key ID**: The Key ID associated with your private key (10 characters)
